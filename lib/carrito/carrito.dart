...
import 'package:login_ui/model/item.dart';
...
class Carrito extends ChangeNotifier{
  ...
  double get impuesto{
    var total = 0.0;
    total = this.subTotal *0.19;
    return total;
  }

  double get total{
    var total = 0.0;
    total = this.subTotal *0.19 + subTotal;
    return total;
  }
  ...
  void decrementarCantidadItem(String producto_id){
    ...
    if(_items.containsKey(producto_id) && _items[producto_id]!.cantidad>1){
      _items.update(
        producto_id,
          (old) =>Item(
            id:old.id,
