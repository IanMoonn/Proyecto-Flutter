...
class PantallaCartaBeforeLogin extends StatefulWidget {
  @override
  _PantallaCartaBeforeLoginState createState() => _PantallaCartaBeforeLoginState();
}
var tilePadding = const EdgeInsets.only(left: 8.0, right: 8, top: 8);
 class _PantallaCartaBeforeLoginState extends State<PantallaCartaBeforeLogin> {
                ...
                child: ListTile(
                  ...
                  title: TextButton(
                    onPressed: (){
                      Navigator.of(context).pushReplacement(
                          MaterialPageRoute(
                              builder: (BuildContext) => LoginPage(showRegisterPage: () {  },)
                          )
                      );
                    },
                    child: const Text(
